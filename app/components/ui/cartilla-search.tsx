...
import { User, ChevronDownIcon, SearchIcon, X } from "lucide-react"
    ...
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`
          ...
          focus:outline-none focus:ring-2 focus:ring-[#00613c] focus:border-[#00613c]
          disabled:bg-gray-50 disabled:text-gray-500 disabled:cursor-not-allowed
          flex items-center justify-between
          ${isOpen ? "ring-2 ring-[#00613c] border-[#00613c]" : ""}
        `}
      >
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <User className="h-4 w-4 text-gray-400 flex-shrink-0" />
          <span className={`truncate ${value ? "text-gray-900" : "text-gray-500"}`}>
            {value || getDynamicPlaceholder()}
          </span>
          {hasFilters && (
            <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded flex-shrink-0">Filtrado</span>
          )}
        </div>
          ...
          <div className="p-2 border-b border-gray-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#00613c] focus:border-[#00613c]"
                autoFocus
              />
            </div>
          </div>
          ...
          <div className="max-h-48 overflow-y-auto">
            {loading ? (
              <div className="p-3 text-center text-gray-500">
                <div className="animate-spin h-4 w-4 border-2 border-[#00613c] border-t-transparent rounded-full mx-auto mb-2"></div>
